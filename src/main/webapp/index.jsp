...
<head>
    ...
    <script src="./js/session.control.error.js"></script>
    
    <%
        if (request.getParameter("error") != null) {
            out.println("<script>codeError();</script>");
        }
    %>
    ...
    <title>Inicio | Dental Clinic</title>
...
<header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
        ...
        <a href="index.jsp" class="logo d-flex align-items-center me-auto me-lg-0">
            ...
            <h1 class="sitename">Dental Clinic</h1>
            <span>.</span>
        </a>
        ...
        <a class="btn-getstarted" href="./login.jsp">Iniciar sesión</a>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center text-center" data-aos="fade-up" data-aos-delay="100">
                <div class="col-xl-6 col-lg-8">
                    <h2>Expertos en tu cuidado dental<span>.</span></h2>
                    <p>Equipo de especialistas en el cuidado dental</p>
                </div>
            </div>
            ...
            <div class="row gy-4 mt-5 justify-content-center" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="col-xl-2 col-md-4" data-aos="fade-up" data-aos-delay="500">
                    <div class="icon-box">
                        ...
                        <h3><a href="">Peritaje</a></h3>
                    </div>
                </div>
                <div class="col-xl-2 col-md-4" data-aos="fade-up" data-aos-delay="600">
                    <div class="icon-box">
                        <i class="bi bi-card-list"></i>
                        <h3><a href="">Cirugía oral</a></h3>
                    </div>
                </div>
                    ...
                    <form action="forms/contact.php" method="post" class="php-email-form" data-aos="fade-up"
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-md-12 text-center">
                                ...
                                <div class="sent-message">Tu mensaje fue enviado con exito, gracias</div>
